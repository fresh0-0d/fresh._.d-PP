      ...
      <div className="relative z-10 max-w-6xl">
        <div className="inline-block mb-6 animate-fade-in-up">
          <span className="text-lg md:text-xl font-bold text-[#0033FF] opacity-90 tracking-wide">
            병원 현장에서의 경험을 바탕으로 고객 여정을 분석하며 CRM 전문성을 쌓아가는 지원자입니다.
          </span>
        ...
        >
            <span style={{ lineHeight: 1.4 }}>
              <span className="inline-block whitespace-nowrap">고객 여정에 대한 이해를 바탕으로</span><br />
              <span className="inline-block whitespace-nowrap">데이터를 통해 병원의 흐름을 이해하는</span><br />
