          ...
          <div className="px-6 mb-10">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 relative overflow-hidden">
              ...
              <p className="text-slate-600 leading-relaxed text-[15px] relative z-10">
                ...
                홍보 업무와 함께 <strong>CS 관련 업무</strong>에도 참여하며 환자와 보호자의 경험(MOT)을 개선하기 위한 아이디어를 고민하고 실행해 왔습니다. 이러한 경험을 바탕으로 <strong>CRM 분야</strong>에서 고객 데이터를 기반으로 한 서비스 개선 역량을 지속적으로 배우고 발전시키고자 합니다.
              </p>
            </div>
          </div>
